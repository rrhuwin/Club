...
class Music_api():
    ...
    # 获取指定音乐列表(相当于主函数)
    def get_music_list(self, keywords,pages):
        music_list = []
        result = Music_api().search(keywords, str(pages))
...
def start(a,pages):
    res2 = Music_api().get_music_list(a,pages)
    keys = []
    vs = []
    res4=[]
    for l in range(len(res2)-1):
        res2 = Music_api().get_music_list(a,pages)[l]
        j = 0
